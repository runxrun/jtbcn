...
<title>JTB International(Canada) Ltd.</title>
...
<link rel="stylesheet" href="/application/scripts/lightslider/src/css/lightslider.css">
<link rel="stylesheet" href="/application/scss/custom.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
<script src="http://ramagardens.assaypage.com/application/scripts/lightslider/src/js/lightslider.js"></script>
</head>
<body class="bg-dark">
<?php 
include_once(__dir__.'/includes/header.php');
include_once(__dir__.'/pages/homepage/home_page.php');

<div class="item">
    <ul id="<?php echo $recommendTicketName; ?>" class="content-slider">
        <?php
        foreach ($recommend_ticket as $key => $item) {
                ...
                <div class="hover-zoom-effect overflow-hidden">
                    <a href="<?php echo $item['link']; ?>" class="d-flex rn-imgcover-center overflow-hidden"
                        ...
                        <img src="/application/images/image-ratio-4-3.gif" class="w-100"
                            onclick="window.open('/tickets/description/keisei-skyliner/TUEyMzAxMDAwXcvb')">
                    </a>
                </div>

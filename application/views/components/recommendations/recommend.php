...
} elseif (strtoupper($currentPage[0]) === 'JRPASS') {
  $recommendSlider = 'recommend-tickets-slider';
  $recommend = [
    [
      'photo' => 'jrpass/osaka-6023336_1280.jpg',
      'title' => 'JR West All Area Pass 7 Days – for JR-WEST All Area Pass 7 days',
      'desc' => 'JR West All Area Pass 7 Days – JR-WEST All Area Pass for 7 days, travel ticket for traveling in the Kansai area. and the western region of Japan Can be used an unlimited number of times Within the specified period and service area Convenient and economical There are also many special privileges.',
      'price' => '$ 108.00 CAD ',
      'link' => 'javascript: void(0);',
    ],
    [
      'photo' => 'jrpass/hiroshima-2467918_1280.jpg',
      'title' => 'JR West Kansai-Hiroshima Area Pass 5 Days – 5 Day JR Pass for Kansai and Hiroshima',
      'desc' => 'JR West Kansai-Hiroshima Area Pass 5 Days – 5-day JR Pass for Kansai and Hiroshima, unlimited travel! Both in Kansai and Hiroshima, Okayama, Takamatsu, Kinosaki Onsen, Amanohashidate, Tottori, Kishi, Shirahama, Kii-Katsuura.',
      'price' => '$ 108.00 CAD ',
      'link' => 'javascript: void(0);',
    ],
    [
      'photo' => 'jrpass/hokkaido-2668477_1280.jpg',
      'title' => 'JR Hokkaido Rail Pass – JR Pass for Hokkaido',
      'desc' => 'The JR Hokkaido Rail Pass is a pass for unlimited travel on JR trains and JR buses in the Hokkaido region.',
      'price' => '$ 108.00 CAD ',
      'link' => 'javascript: void(0);',
    ],
    [
      'photo' => 'jrpass/japan-4917561_1280.jpg',
      'title' => 'JR Sapporo-Furano Area Pass 4 Days – JR Pass for Sapporo-Furano in Hokkaido',
      'desc' => 'JR Sapporo-Furano Area Pass 4 Days – JR Pass for Sapporo-Furano in Hokkaido. You can explore Sapporo and Furano for 4 consecutive days with one pass. Furano is also famous for its flower fields and beautiful natural hillside views.',
      'price' => '$ 108.00 CAD ',
      'link' => 'javascript: void(0);',
    ],
  ];

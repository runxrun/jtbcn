<?php
$recommendPackageName = 'recommend-hotels-slider';
$recommend_package = [
  [
    'photo' => 'hotels/6e49dada27c8000bb92d5b314f848036.webp',
    'title' => 'Best Western Osaka Tsukamoto',
    'desc' => '2-21-9 Tsukamoto, Yodogawa-Ku, Juso, Osaka, Japan',
    'price' => '$ 170.00 CAD ',
        ...
        <div class="pb-4 bg-white shadow-sm overflow-hidden rounded-1 border h-100">
          <div class="hover-zoom-effect overflow-hidden">
            <a href="<?php echo $item['link']; ?>" class="d-flex rn-imgcover-center overflow-hidden #1?" style="background-image: url('<?php echo $image; ?>');">
              <img src="/application/images/image-ratio-4-3.gif" class="w-100" onclick="window.open('/hotels/description/downtown-osaka-walking-and-local-food-tour/TUEyMzAxMDAwMDQw')">
            </a>
          </div>
          <div class="pt-3 px-3 fs-7 fw-bold text-dark" onclick="window.open('/hotels/description/downtown-osaka-walking-and-local-food-tour/TUEyMzAxMDAwMDQw')">
            <?php echo $item['title']; ?>
          </div>

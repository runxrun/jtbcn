  ...
  <div class="container py-4  ">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb fs-8">
        ...
        <li class="breadcrumb-item active" aria-current="page">Himeji</li>
      </ol>
    </nav>
    ...
    <div class="pb-4">
      <div class="row g-3">
        <div class="col-12 col-lg-4">
          <div class="bg-light">
            <div class="w-100 bg-light rn-imgcover-center rounded-1" style="background-image: url('/application/images/toppage/himeji-3424658_1920.jpg'); ">

  ...
  <div class="container py-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb fs-8">
        ...
        <li class="breadcrumb-item"><a href="<?php echo '/blog/japan-information/food-culture-ramen/TUEyMzA0MDAxMg-TUEyOpE8CXGdAe' . $getURLLang; ?>" class="text-primary text-decoration-none">Food Culture - Ramen</a></li>
    ...
    <div class="row g-4">
      <div class="col-12 col-lg-9">
        ...
        <br>
        <div>
          <img src="/application/images/blogs/japanese-cuisine-6799801_1280.jpg" class="img-fluid">
        </div>
        <br>
        <br>
        <p>

        ...
        for ($ticket = 1; $ticket <= 2; $ticket++) {
            ...
            <div class="pt-4">
                ...
                <button class="btn bg-white rounded-0 w-100 text-start border p-3" data-bs-toggle="collapse"
                    data-bs-target="<?php echo '#service' . $ticket; ?>">
                        ...
                        <div class="col-12 d-flex flex-wrap">
                            <div class="col-12 col-lg-9 p-3">
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="pb-3 fs-7">
                                        For CHILD (6-11 years) tickets, please contact to JTB Canada via Email, LINE,
                                        telephone, and SNS message.
                                        <br>
                                        <br>
                                        <b>Where to exchange coupons</b>
                                        <br>
                                        Skyliner ticket counter (Narita Airport Terminal 1 Station / Narita Airport Terminal
                                        2⋅3 Station)
                                        <br>
                                        <br>
                                        <b>SKYLINER & KEISEI INFORMATION CENTER</b>
                                        <br>
                                        Keisei Ueno Station (Skyliner ticket counter on the day of purchase) and Nippori
                                        Station (Liner ticket counter at the JR transfer gate).
                                        <br>
                                        <br>
                                        * Skyliner Coupon is a one-way service between Narita Airport Terminal 1
                                        Station/Narita Airport Terminal 2・3 Station ⇔ Nippori Station/Keisei Ueno Station,
                                        or vice versa.
                                        <br>
                                        <br>

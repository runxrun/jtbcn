              ...
              <div class="row g-2">
                ...
                <div class="col-12">
                  ...
                  <div class="nav row g-2">
                    ...
                    ?>
                      <div class="col-auto">
                        <button class="btn rounded-1 fs-8 text-nowrap btn-outline-primary <?php echo $classTab; ?>" data-bs-toggle="pill" data-bs-target="<?php echo '#tab' . $key; ?>" type="button">
                          <?php echo $item['time']; ?>
                        </button>
                      </div>
                    <?php
                        ...
                        <div class="pt-4">
                          <div class="row gy-2 gx-3">
                            ...
                            <div class="col-6 col-sm-4 col-lg-3">
                              ...
                              <div class="fs-7 text-dark fw-bold"><?php echo $item['time']; ?></div>
                            </div>
                            <div class="col-6 col-sm-4 col-lg-3">

        ...
        <div class="row g-0">
                ...
                <div class="col-12">
                  ...
                  <div class="nav row g-2">
                    ...
                    foreach ($dataTime as $key => $item) {
                      ...
                      ?>
                      <div class="col-auto">
                        <button class="btn rounded-1 fs-8 text-nowrap btn-outline-primary <?php echo $classTab; ?>"
                          data-bs-toggle="pill" data-bs-target="<?php echo '#tab' . $key; ?>" type="button">
                          <?php echo $item['time']; ?>
                        </button>
                      </div>
                      <?php
                  ...
                  <div class="tab-content" id="pills-tabContent">
                    ...
                    foreach ($dataTime as $key => $item) {
                      ...
                      ?>
                      <div class="tab-pane fade <?php echo $classTab; ?>" id="<?php echo 'tab' . $key; ?>">
                        <div class="pt-4">
          ...
          <div class="col-12 col-lg-3 rn-border-start">
            <div class="">
              ...
              <div class="py-3 px-3">
                <button target="_blank" class="btn py-2 btn-sm w-100 btn-primary" onclick="window.open('/cart','_self');">
                  Add to cart
                </button>
              </div>
            </div>

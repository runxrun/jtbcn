                    ...
                    <div class="pb-3 border-top">
                      <div class="row g-3">
                        ...
                        <div class="col-12 col-lg-3">
                          ...
                          <div class="pt-3">
                            <button class="btn btn-outline-primary w-100 fs-7 fw-bold rounded-1 py-2" onclick="window.open('/activities/description/downtown-osaka-walking-and-local-food-tour/TUEyMzAxMDAwMDQw')">
                              View Detail
                            </button>
                          </div>
                          <div class="pt-3">

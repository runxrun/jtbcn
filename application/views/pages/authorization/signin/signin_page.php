            ...
            <div class="col-12 col-md-8 col-xl-5">
                ...
                <div class="pb-2">
                    <div class="input-group mb-3">
                        ...
                        <input #us type="text" class="form-control py-2 fs-7 rounded-0"
                            placeholder="<?php echo getTS('_EmailAddress', $lang, $mlangs); ?>" />
                    </div>
                </div>
                <div class="pb-2">
                    <div class="input-group mb-3">
                        ...
                        <input #pw type="password" class="form-control py-2 fs-7 rounded-0"
                            placeholder="<?php echo getTS('_Password', $lang, $mlangs); ?>" />
                    </div>
                </div>
                <div class="pt-2 pb-3">
                    <button class="btn btn-primary w-100 p-3 fs-7 rounded-1"
                        onclick="window.open('/account/bookings', '_parent')">
                        <?php echo getTS('_SignIn', $lang, $mlangs); ?>
                    </button>
                </div>
                <div class="py-4">
